...
public class CourseAddFragment extends Fragment {
    ...
    private final static String COURSE_ADD_URL
            = "http://cssgate.insttech.washington.edu/~dwood253/addCourse.php?";
...
//    private OnFragmentInteractionListener mListener;
    ...
    public void setmCoursePrereqsEditText(EditText mCoursePrereqsEditText) {
        this.mCoursePrereqsEditText = mCoursePrereqsEditText;
    }

    public void setmCourseShortDescEditText(EditText mCourseShortDescEditText) {
        this.mCourseShortDescEditText = mCourseShortDescEditText;
    }

    public void setmCourseLongDescEditText(EditText mCourseLongDescEditText) {
        this.mCourseLongDescEditText = mCourseLongDescEditText;
    }
